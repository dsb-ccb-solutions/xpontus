    ...
    public void setName(String name)
      {
        ...
        this.putValue(Action.NAME,
            MessageProvider.getinstance().getMessage(name));
      }
    ...
    public void setDescription(String description)
      {
        ...
        this.putValue(Action.SHORT_DESCRIPTION,
            MessageProvider.getinstance().getMessage(this.description));
      }
    ...
    public void warning(String message)
      {
        JOptionPane.showMessageDialog(XPontusWindow.getInstance().getFrame(),
            message, XPontusWindow.getInstance().getI18nMessage("msg.error"),
