...
public class XMLParser extends antlr.LLkParser implements XMLParserTokenTypes {
	public static final String[] _tokenNames = { "<0>", "EOF", "<2>",
			"NULL_TREE_LOOKAHEAD", "XMLDECL", "DOCTYPE", "EMPTYTAG",
			"STARTTAG", "ENDTAG", "CDATABLOCK", "PCDATA", "COMMENT", "PI",
			"INTERNAL_DTD", "PI_OR_XMLDECL", "COMMENT_DATA", "PCDATA_DATA",
	...
	private XMLParserLocator locator = new XMLParserLocator();

	private HashMap elm2attributes = new HashMap();
	...
	public void reportError(RecognitionException arg0) {
		try {
			if (errorHandler != null) {
				...
				SAXParseException parseException = new SAXParseException(arg0
	...
	public final void element() throws RecognitionException,
		...
		try { // for error handling
			...
			case EMPTYTAG: {
				...
				// System.err.println("End tag at line:" + empty.getLine());
				endTag(empty);
	...
	public final void element_or_data() throws RecognitionException,
			TokenStreamException {
		try { // for error handling
