/* Generated By:JavaCC: Do not edit this line. PropertiesParserTokenManager.java */
...
public class PropertiesParserTokenManager implements PropertiesParserConstants
{
...
static final int[] jjnextStates = {
   10, 12, 13, 15, 17, 7, 8, 9, 10, 12, 14, 15, 17, 2, 3, 5, 
   9, 10, 12, 10, 12, 13, 14, 15, 17, 19, 11, 16, 0, 1, 4, 0, 
   1, 3, 0, 1, 4, 3, 3, 0, 4, 1, 5, 
};
...
public PropertiesParserTokenManager(CharStream stream){
   input_stream = stream;
}
public PropertiesParserTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
