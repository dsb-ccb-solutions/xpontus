 ...
 * @author  Yves Zoundi
 */
public class ScenarioFormView extends javax.swing.JDialog implements java.util.Observer{
    ...
    private void initComponents() {
        ...
        outputLabel.setText(XPontusWindow.getInstance().getI18nMessage("form.editscenario.output"));
        ...
        outputList.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "XML", "HTML", "PDF", "SVG", "TEXT", "STX" , "XQUERY"}));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        useCurrentDocumentOption.setText(XPontusWindow.getInstance().getI18nMessage("form.editscenario.usecurrentdocument"));
        ...
        nameLabel.setText(XPontusWindow.getInstance().getI18nMessage("form.editscenario.name"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        ...
        paramsPanel.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(XPontusWindow.getInstance().getI18nMessage("form.editscenario.parameters")), javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1)), javax.swing.BorderFactory.createEmptyBorder(2, 2, 2, 2)));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                XPontusWindow.getInstance().getI18nMessage("form.editscenario.parameter"),
                XPontusWindow.getInstance().getI18nMessage("form.editscenario.value")
            }
        ));
        ...
        outputButton.setText(XPontusWindow.getInstance().getI18nMessage("form.editscenario.outputfile"));
