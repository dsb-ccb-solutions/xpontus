 ...
 * @author  Yves Zoundi
 */
public class BatchValidationForm extends JDialog{
    ...
    private void initComponents() {
        ...
        setTitle( XPontusWindow.getInstance().getI18nMessage("form.batchvalidation.title"));
        selectButton.setText(XPontusWindow.getInstance().getI18nMessage("form.batchvalidation.browse"));
        selectButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        selectButton.addActionListener((ActionListener)EventHandler.create(ActionListener.class, controller, BatchValidationFormController.SELECT_PATH_METHOD));

        pathTF.setEditable(false);

        validateButton.setText(XPontusWindow.getInstance().getI18nMessage("form.batchvalidation.validate"));
        validateButton.addActionListener((ActionListener)EventHandler.create(ActionListener.class, controller, BatchValidationFormController.VALIDATE_XML_METHOD));

        cancelButton.setText(XPontusWindow.getInstance().getI18nMessage("cancel.key"));
        cancelButton.setActionCommand("cancel");
        cancelButton.addActionListener((ActionListener)EventHandler.create(ActionListener.class, controller, BatchValidationFormController.CANCEL_METHOD));

        extensionLabel.setText(XPontusWindow.getInstance().getI18nMessage("form.batchvalidation.extension"));

        extensionTF.setText(".xml");

        addButton.setText(XPontusWindow.getInstance().getI18nMessage("add.key"));
        addButton.addActionListener((ActionListener)EventHandler.create(ActionListener.class, controller, BatchValidationFormController.ADD_EXTENSION_METHOD));

        removeButton.setText(XPontusWindow.getInstance().getI18nMessage("delete.key"));
        removeButton.addActionListener((ActionListener)EventHandler.create(ActionListener.class, controller, BatchValidationFormController.REMOVE_EXTENSION_METHOD));

        listTitleLabel.setText(XPontusWindow.getInstance().getI18nMessage("form.batchvalidation.xmlextensions"));

        extensionsList.setModel(model);
        scrollPane.setViewportView(extensionsList);

        recurseOption.setSelected(true);
        recurseOption.setText(XPontusWindow.getInstance().getI18nMessage("form.batchvalidation.recurse"));
    ...
    private BatchValidationFormController controller;
