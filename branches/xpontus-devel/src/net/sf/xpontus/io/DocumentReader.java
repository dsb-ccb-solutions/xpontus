...
public class DocumentReader extends Reader {
	...
	/**
	 * Modifying the document while the reader is working is like pulling the
	 * rug out from under the reader. Alerting the reader with this method (in a
	 * nice thread safe way, this should not be called at the same time as a
	 * read) allows the reader to compensate.
	 */
	...
	/**
	 * Read and fill the buffer. This method will always fill the buffer unless
	...
	/**
	 * Reset this reader to the last mark, or the beginning of the document if a
	...
	/**
	 * Skip characters of input. This method will always skip the maximum number
	 * of characters unless the end of the file is reached.
	 * 
	 * @param n
