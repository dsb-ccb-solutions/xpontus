 ...
 *
 * @author Slava Pestov
 * @version $Id: PerlTokenMarker.java,v 1.1.1.1 2005/12/08 01:34:35 yveszoundi Exp $
 */
        ...
        for (int i = offset; i < length; i++) {
            ...
            case Token.NULL:
                ...
                case '@':
                    ...
                    if ((length - i) > 1) {
                        if ((c == '&') &&
                                ((array[i1] == '&') ||
                                Character.isWhitespace(array[i1]))) {
                            i++;
                        } else {
                            addToken(i - lastOffset, token);
            ...
            case Token.COMMENT2:
                ...
                if (i == offset) {
                    ...
                    if (((length - i) > 3) &&
                            SyntaxUtilities.regionMatches(false, line, offset,
                                "=cut")) {
                        token = Token.NULL;
                    }
