 ...
 * @author  Yves Zoundi
 */
public class EditorPanelImpl extends javax.swing.JPanel implements IOptionPanel{
    
    private BeanAdapter adapter;
    private ComboBoxAdapter fontFamilyModel,  fontSizeModel;
    
    /** Creates new form EditorPanel */
    public EditorPanelImpl() {
    ...
    public void read(){
        ...
        m = (EditorOptionModel)m.load();
        model.setShowLineNumbers(m.isShowLineNumbers());
        model.setTabSize(m.getTabSize());
        model.setFontName(m.getFontName());
        model.setFontSize(m.getFontSize());
        model.setCursorRate(m.getCursorRate());
    }
