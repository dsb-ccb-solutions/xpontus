...
public class SearchFormView extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle(XPontusWindow.getInstance().getI18nMessage("action.search.name"));
        
        findLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        findLabel.setText(XPontusWindow.getInstance().getI18nMessage("find.label"));
        findLabel.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        
        
        findButton.setText(XPontusWindow.getInstance().getI18nMessage("find.key"));
        ...
        replaceLabel.setText(XPontusWindow.getInstance().getI18nMessage("replace.label"));
        replaceLabel.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        
        
        replaceButton.setText(XPontusWindow.getInstance().getI18nMessage("replace.key"));
        ...
        upOption.setText(XPontusWindow.getInstance().getI18nMessage("up.key"));
        upOption.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        upOption.setMargin(new java.awt.Insets(0, 0, 0, 0));
        
        matchCaseOption.setText(XPontusWindow.getInstance().getI18nMessage("matchcase.key"));
