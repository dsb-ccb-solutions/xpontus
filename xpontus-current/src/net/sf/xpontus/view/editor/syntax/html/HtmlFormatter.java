 ...
 * contents of the document to a specified output stream. It assumes that the
    ...
    public static void main(String[] args) throws Exception
      {
        ...
        try
          {
            document = new HtmlParser(new FastCharStream(
...
/**
 * Utility class, used by HtmlFormatter, which tentatively tries to format the
 * contents of an HtmlDocument.TagBlock to see if the entire block can fit on
 * the rest of the line. If it cannot, it gives up and indicates failure through
