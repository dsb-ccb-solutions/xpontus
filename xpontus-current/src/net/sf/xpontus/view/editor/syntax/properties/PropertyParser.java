...
public class PropertyParser implements ILexer, PropertyParserConstants
  {
    ...
    /**
     * Add an exception to the list of exceptions. Rather than failing on any
     * exception, this parser will continue parsing and will accumulate any/all
     * exceptions.
     *
     * @param pe
     *            a ParseException to accumulate
     */
        ...
        try
          {
            ...
            /*
             * key -- need to trim as the regex production can capture
             * whitespace, and by definition, the key cannot contain any
            ...
            /*
             * value -- need to combine multi-line values into a single line.
             * Leading whitespace on continuation lines is discarded, as is
             * leading whitespace at the start of the value.
             */
