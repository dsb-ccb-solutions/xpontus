...
import net.sf.xpontus.view.editor.syntax.SyntaxSupportFactory;
...
public class SyntaxEditorkit extends DefaultEditorKit implements ViewFactory
  {
     ...
     *
     * @param textEval
     *            Indicate whether to operate for the text eval area
     */
     ...
     * @param extension
     */
    public SyntaxEditorkit(JEditorPane editor, String extension)
      {
        this.editor = editor;
        this.syntaxSupport = SyntaxSupportFactory.createSyntax(extension);
        doc = new SyntaxDocument2(editor, this.syntaxSupport);
      }

    /**
     * Returns an instance of a view factory that can be used for creating views
     * from elements. This implementation returns the current instance, because
     * this class already implements <code>ViewFactory</code>.
     */
    ...
    public View create(Element elem)
      {
        return new SyntaxView2(elem);
      }

    /**
     * Creates a new instance of the default document for this editor kit. This
     * returns a new instance of <code>DefaultSyntaxDocument</code>.
     *
