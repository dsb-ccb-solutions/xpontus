 ...
 */
package net.sf.xpontus.plugins.scenarios.saxon8;
...
public class Saxon8TransformationPluginImpl implements ScenarioPluginIF {
    ...
    private Log log = LogFactory.getLog(Saxon8TransformationPluginImpl.class);

    public Saxon8TransformationPluginImpl() {
    }

    public String getName() {
        return "Saxon8:" + SAXON8_TRANSFORMATION;
    }

    public String[] getProcessors() {
        return new String[] { "Saxon8:" + SAXON8_TRANSFORMATION };
    }

    public String[] getTransformationTypes() {
        return new String[] { "(XQUERY, XML, HTML, Text)" };
    }

    public String[] getOutputTypes() {
        return new String[] { "XQUERY", "HTML", "XML", "Text" };
    }
