 ...
 */
public class HtmlParser implements LexerPluginIF, HtmlParserConstants
{
    ...
    final public HtmlDocument.ElementSequence ElementSequence()
...
label_1: 
    ...
    final public HtmlDocument.AttributeList AttributeList()
        throws ParseException
    {
...
label_2: 
    ...
    final public HtmlDocument.ElementSequence BlockContents()
        throws ParseException
    {
        Token t;
...
label_3: 
    ...
    final public HtmlDocument.HtmlElement ScriptBlock()
        throws ParseException
    {
        HtmlDocument.AttributeList alist;
    ...
    final public HtmlDocument.HtmlElement StyleBlock()
        throws ParseException
    {
        HtmlDocument.AttributeList alist;
        HtmlDocument.ElementSequence e;
...
label_4: 
    ...
    {
        if (jj_scan_token(TAG_START))
        {
            return true;
        }

        if (jj_scan_token(TAG_NAME))
        {
            return true;
        }
    ...
    private static void jj_la1_0()
    {
        jj_la1_0 = new int[]
            {
                0x1f800, 0xe000, 0x10800, 0x2000000, 0x400000, 0x1800000, 0x0,
                0x0, 0x0, 0x0, 0x80000001,
            };
    }
    ...
    private static void jj_la1_1()
    {
        jj_la1_1 = new int[]
            {
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x380, 0x380, 0x7, 0x7, 0x0,
            };
    }
