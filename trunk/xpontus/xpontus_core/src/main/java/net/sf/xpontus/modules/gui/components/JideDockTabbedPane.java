...
{ 
	private static final long serialVersionUID = 2891249275622539348L;
    ...
    private Map<DockKey, Action> closeActions = new HashMap<DockKey, Action> (); // DockKey , Action
    ...
    public JideDockTabbedPane()
    {
        ...
        {
            setTabShape(JideTabbedPane.SHAPE_ROUNDED_FLAT);
                ...
                public void mouseClicked(MouseEvent e)
                {
                            ...
                            SwingUtilities.isLeftMouseButton(e))
                    {
                        ...
                        if ((d != null) && d.getDockKey().isMaximizeEnabled() &&
                                (d.getDockKey().getDockableState() == DockableState.STATE_DOCKED))
                        { // 2005/10/10 don't maximize floatings
                            desktop.maximize(d);
                        }
                    }
                }
            ...
            if (tabbounds.contains(p))
            {
                ...
                if (drop)
                {
                    ...
                    else
                    {
                        ...
                        if (base.getDockKey().getDockableState() == DockableState.STATE_FLOATING)
                        { //2005/12/09
    ...
    public boolean startDragComponent(Point p)
    {
        ...
        { // either after the last tab or between tabs
    ...
    {
        private static final long serialVersionUID = 378517123557491280L;
