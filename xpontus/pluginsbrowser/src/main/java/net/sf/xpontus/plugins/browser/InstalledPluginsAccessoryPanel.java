...
{
    private static final long serialVersionUID = -5802808096852459296L;
                        ...
                        try
                        {
                            ...
                            catch (Exception unregisterException)
                            {
                                ...
                                sb.append(
                                  ...
                                  .append(spd.getId()).appendNewLine()
                                  .append(unregisterException.getMessage());
                            ...
                            try
                            {
                                ...
                                XPontusComponentsUtils.showInformationMessage(
                                    "The plugin will be uninstall when xpontus restarts....");
                            }
                            catch (Exception err)
                            {
                                StrBuilder sb = new StrBuilder();
                                sb.append(
                                  ...
                                  .append(" directory for plugin with id:\n It might have plugins requiring it..")
                                  .append(spd.getId()).appendNewLine()
