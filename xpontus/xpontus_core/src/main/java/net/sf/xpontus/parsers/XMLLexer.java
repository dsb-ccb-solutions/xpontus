...
public class XMLLexer extends antlr.CharScanner implements XMLParserTokenTypes,
    TokenStream {
...
tryAgain: 
    ...
    public final void mDOCTYPE(boolean _createToken)
        ...
        case 'S': {
            ...
            case 'S': {
                ...
                text.setLength(_saveIndex);
                sys1 = _returnToken;
                dtdLocation = sys1.getText();
                dtdpubid = pub.getText();
            ...
            case 'P': {
                ...
                sys2 = _returnToken;
                dtdpubid = pub.getText();
                dtdLocation = sys2.getText();

                break;
            }

            default:throw new NoViableAltForCharException((char) LA(1),
                    getFilename(), getLine(), getColumn());
            }
...
_loop65: 
    ...
    protected final void mINTERNAL_DTD(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
...
_loop26: 
    ...
    public final void mPI_OR_XMLDECL(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
...
_loop31: 
    ...
    protected final void mATTR(boolean _createToken, AttributesImpl attributes)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
        ...
        if (name.getText().equals("xsi:noSchemaLocation") ||
                name.getText().equals("xsi:schemaLocation")) {
...
_loop35: 
    ...
    public final void mENDTAG(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
    ...
    public final void mSTARTTAG(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
...
_loop42: 
    ...
    protected final void mPCDATA_DATA(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
...
_loop48: 
    ...
    public final void mCDATABLOCK(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
    ...
    protected final void mINTERNAL_CDATA_DATA(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
...
_loop52: 
    ...
    protected final void mSTRING_NO_QUOTE(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
...
_loop60: 
    ...
    protected final void mNAMECHAR(boolean _createToken)
        throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
