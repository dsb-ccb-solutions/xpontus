...
public class CloseTabPaneUI extends BasicTabbedPaneUI {
    ...
    public CloseTabPaneUI() {
        ...
        closeItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ((CloseTabbedPane) tabPane).fireCloseTabEvent(null,
    ...
    protected void layoutLabel(int tabPlacement, FontMetrics metrics,
        ...
        SwingUtilities.layoutCompoundLabel((JComponent) tabPane, metrics,
            ...
            SwingUtilities.CENTER, SwingUtilities.CENTER, tabRect, iconRect,
    ...
    private void initMnemonics() {
        ...
        SwingUtilities.replaceUIInputMap(tabPane,
            JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, mnemonicInputMap);
    }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ((pane != null) && (pane.getUI() instanceof CloseTabPaneUI)) {
                ...
                if ((command != null) && (command.length() > 0)) {
                    ...
                    Integer index = (Integer) ui.mnemonicToIndexMap.get(new Integer(
                                mnemonic));
    ...
    class MyMouseHandler extends MouseHandler {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if ((e.getClickCount() > 1) && (overTabIndex != -1)) {
                ((CloseTabbedPane) tabPane).fireDoubleClickTabEvent(e,
                    overTabIndex);
            }
        }
